-- Init Node Role Data
INSERT INTO `${table.prefix}node_role`(id,role_code, role_name, role_level, role_desc) VALUES (1233225128846229505, 'administrator', '管理员', 0, '工作空间中最高权限的角色');
INSERT INTO `${table.prefix}node_role`(id,role_code, role_name, role_level, role_desc) VALUES (1233225129022390273, 'none', '禁止访问', 1, '禁止访问节点');
INSERT INTO `${table.prefix}node_role`(id,role_code, role_name, role_level, role_desc) VALUES (1233225129026584577, 'manager', '可管理', 2, '管理工作目录相关操作');
INSERT INTO `${table.prefix}node_role`(id,role_code, role_name, role_level, role_desc) VALUES (1233225129026584578, 'editor', '可编辑', 3, '编辑工作目录名称、移动节点');
INSERT INTO `${table.prefix}node_role`(id,role_code, role_name, role_level, role_desc) VALUES (1233225129026584579, 'readonly', '可查看', 4, '只可查看工作目录');
...
INSERT INTO `${table.prefix}node_resource`(id,resource_code,resource_name,resource_type,resource_desc,field_name) VALUES (1233225147284389889, 'CREATE_NODE', '新建节点', 0, '具有此资源的角色，可以新建文件夹、新建数表', 'childCreatable');
INSERT INTO `${table.prefix}node_resource`(id,resource_code,resource_name,resource_type,resource_desc,field_name) VALUES (1233225147292778498, 'UPDATE_NODE', '更新节点', 0, '具有此资源的角色，可以对节点进行编辑操作，更新节点的数据', 'editable');
INSERT INTO `${table.prefix}node_resource`(id,resource_code,resource_name,resource_type,resource_desc,field_name) VALUES (1233225147292778499, 'RENAME_NODE', '重命名节点', 0, '具有此资源的角色，可以对节点进行重命名操作', 'renamable');
INSERT INTO `${table.prefix}node_resource`(id,resource_code,resource_name,resource_type,resource_desc,field_name) VALUES (1233225147292778500, 'DELETE_NODE', '删除节点', 0, '具有此资源的角色，可以对节点进行删除操作', 'removable');
INSERT INTO `${table.prefix}node_resource`(id,resource_code,resource_name,resource_type,resource_desc,field_name) VALUES (1233225147301167105, 'MOVE_NODE', '移动节点', 0, '具有此资源的角色，可以对节点进行层级的移动调整', 'movable');
INSERT INTO `${table.prefix}node_resource`(id,resource_code,resource_name,resource_type,resource_desc,field_name) VALUES (1233225147305361409, 'READ_NODE', '读取节点', 0, '具有此资源的角色，可以读取节点的数据', 'readable');
INSERT INTO `${table.prefix}node_resource`(id,resource_code,resource_name,resource_type,resource_desc,field_name) VALUES (1233225147305361410, 'IMPORT_NODE', '导入节点', 0, '具有此资源的角色，可以在「工作目录」的快捷菜单中看到「导入数表」按钮，并且可以执行导入操作', 'importable');
INSERT INTO `${table.prefix}node_resource`(id,resource_code,resource_name,resource_type,resource_desc,field_name) VALUES (1233225147309555714, 'EXPORT_NODE', '导出节点', 0, '具有此资源的角色，可以在「工作目录」的快捷菜单中看到「导出」按钮，并且可以执行导出操作', 'exportable');
INSERT INTO `${table.prefix}node_resource`(id,resource_code,resource_name,resource_type,resource_desc,field_name) VALUES (1233225147309555715, 'DUPLICATE_NODE', '复制节点', 0, '具有此资源的角色，可以在「工作目录」的快捷菜单中看到「复制数表」按钮，并且可以执行复制数表的操作', 'copyable');
INSERT INTO `${table.prefix}node_resource`(id,resource_code,resource_name,resource_type,resource_desc,field_name) VALUES (1233225147313750018, 'ASSIGN_NODE_ROLE', '分配节点角色', 0, '具有此资源的角色，可以对节点进行角色权限的设置。针对当前节点给「组织单元」指定角色', 'nodeAssignable');
INSERT INTO `${table.prefix}node_resource`(id,resource_code,resource_name,resource_type,resource_desc,field_name) VALUES (1233225147313750019, 'READ_VIEW', '读取视图', 1, '具有此资源的角色，可以查看数表的指定视图', 'viewReadable');
INSERT INTO `${table.prefix}node_resource`(id,resource_code,resource_name,resource_type,resource_desc,field_name) VALUES (1233225147313750020, 'RENAME_VIEW', '重命名视图', 1, '具有此资源的角色，可以重命名数表的视图名称', 'viewRenamable');
INSERT INTO `${table.prefix}node_resource`(id,resource_code,resource_name,resource_type,resource_desc,field_name) VALUES (1233225147313750021, 'DELETE_VIEW', '删除视图', 1, '具有此资源的角色，可以删除数表的指定视图', 'viewMovable');
INSERT INTO `${table.prefix}node_resource`(id,resource_code,resource_name,resource_type,resource_desc,field_name) VALUES (1233225147313750022, 'UPDATE_VIEW_CONFIG', '更新视图配置', 1, '具有此资源的角色，可以修改更新数表当前当前视图的配置', 'viewEditable');
INSERT INTO `${table.prefix}node_resource`(id,resource_code,resource_name,resource_type,resource_desc,field_name) VALUES (1233225147313750023, 'LOCK_VIEW_CONFIG', '锁定视图', 1, '具有此资源的角色，可以锁定数表的指定视图，被锁定的视图不能编辑配置', 'viewLockable');
INSERT INTO `${table.prefix}node_resource`(id,resource_code,resource_name,resource_type,resource_desc,field_name) VALUES (1233225147322138625, 'CREATE_FIELD', '新建字段', 2, '具有此资源的角色，可以在数表中添加新的字段，包括复制字段', 'fieldCreatable');
INSERT INTO `${table.prefix}node_resource`(id,resource_code,resource_name,resource_type,resource_desc,field_name) VALUES (1233225147322138626, 'UPDATE_FIELD', '更新字段', 2, '具有此资源的角色，可以更新数表中已有的字段配置', 'fieldEditable');
INSERT INTO `${table.prefix}node_resource`(id,resource_code,resource_name,resource_type,resource_desc,field_name) VALUES (1233225147322138627, 'DELETE_FIELD', '删除字段', 2, '具有此资源的角色，可以删除数表中已有的字段', 'fieldMovable');
INSERT INTO `${table.prefix}node_resource`(id,resource_code,resource_name,resource_type,resource_desc,field_name) VALUES (1233225147322138628, 'CREATE_RECORD', '新建记录', 3, '具有此资源的角色,，可以在数表中插入记录包括复制记录', 'recordAddable');
INSERT INTO `${table.prefix}node_resource`(id,resource_code,resource_name,resource_type,resource_desc,field_name) VALUES (1233225147322138629, 'READ_RECORD', '读取记录', 3, '具有此资源的角色,，可以在数表中查看记录数据', 'recordReadable');
INSERT INTO `${table.prefix}node_resource`(id,resource_code,resource_name,resource_type,resource_desc,field_name) VALUES (1233225147322138630, 'UPDATE_RECORD', '更新记录', 3, '具有此资源的角色,，可以在数表中编辑记录数据', 'recordEditable');
INSERT INTO `${table.prefix}node_resource`(id,resource_code,resource_name,resource_type,resource_desc,field_name) VALUES (1233225147322138631, 'DELETE_RECORD', '删除记录', 3, '具有此资源的角色,，可以在数表中删除已有记录', 'recordMovable');
