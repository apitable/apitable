...
export function getLanguage() {
  ...
  const language = typeof _global == 'object' && _global.__initialization_data__ && _global.__initialization_data__.locale != 'und' && _global.__initialization_data__.locale;
