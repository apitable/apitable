import { CURSOR_MOVE, DATASHEET_ACTIVE_COLLABORATOR, DATASHEET_DEACTIVATE_COLLABORATOR } from 'store/action_constants';
import { ICursorMove, ICollaborator } from 'store/interface';
