...
export interface Templates {
    ...
    add_record_out_of_limit:                     LivingstoneSouthernWhiteFacedOwl;
    add_record_soon_to_be_limit:                 LivingstoneSouthernWhiteFacedOwl;
...
export interface AssignedToGroupClass {
    ...
    billing_notify?:        any[];
    mail_template_subject?: string;
    notifications?:         PurpleNotifications;
}

export interface PurpleNotifications {
