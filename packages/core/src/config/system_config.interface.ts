...
export interface Settings {
    ...
    api_panel_help_url:                                  CustomerServiceQrCode;
    api_rate_day:                                        CustomerServiceQrCode;
    api_rate_inute:                                      CustomerServiceQrCode;
    api_rate_second:                                     CustomerServiceQrCode;
    api_times_per_day:                                   CustomerServiceQrCode;
    api_times_per_hour:                                  CustomerServiceQrCode;
    api_times_per_minute:                                CustomerServiceQrCode;
    api_times_per_second:                                CustomerServiceQrCode;
    apifox_link:                                         CustomerServiceQrCode;
    assistant:                                           CustomerServiceQrCode;
    assistant_activity_train_camp_end_time:              CustomerServiceQrCode;
    assistant_activity_train_camp_start_time:            CustomerServiceQrCode;
    assistant_release_history_url:                       CustomerServiceQrCode;
    automation_action_send_msg_to_dingtalk:              CustomerServiceQrCode;
    automation_action_send_msg_to_feishu:                CustomerServiceQrCode;
    automation_action_send_msg_to_wecom:                 CustomerServiceQrCode;
    ...
    billing_enterprise_qr_code:                          CustomerServiceQrCode;
    billing_pay_contact_us:                              CustomerServiceQrCode;
    billing_pay_success_qr_code:                         CustomerServiceQrCode;
    billing_space_upgrade_url:                           CustomerServiceQrCode;
    ...
    datasheet_max_view_count_per_sheet:                  CustomerServiceQrCode;
    datasheet_unlogin_user_avatar:                       CustomerServiceQrCode;
    default_avatar:                                      CustomerServiceQrCode;
    default_widget_template_url:                         CustomerServiceQrCode;
    delete_account_step1_cover:                          CustomerServiceQrCode;
    delete_account_step2_email_icon:                     CustomerServiceQrCode;
    delete_account_step2_mobile_icon:                    CustomerServiceQrCode;
    ...
    emoji_database_32:                                   CustomerServiceQrCode;
    emoji_database_64:                                   CustomerServiceQrCode;
    ...
    experimental_features_unsynchronized_view_intro_img: CustomerServiceQrCode;
    ...
    field_cascade:                                       CustomerServiceQrCode;
    ...
    help_assistant:                                      CustomerServiceQrCode;
    help_contact_us_type:                                CustomerServiceQrCode;
    help_developers_center_url:                          CustomerServiceQrCode;
    help_download_app:                                   CustomerServiceQrCode;
    help_intro_custom_subdomain:                         CustomerServiceQrCode;
    help_join_chatgroup_url:                             CustomerServiceQrCode;
    help_official_website_url:                           CustomerServiceQrCode;
    help_product_roadmap_url:                            CustomerServiceQrCode;
    help_solution_url:                                   CustomerServiceQrCode;
    help_subscribe_demonstrate_form_url:                 CustomerServiceQrCode;
    help_user_community_url:                             CustomerServiceQrCode;
    help_user_community_url_dev:                         CustomerServiceQrCode;
    help_user_community_url_prod:                        CustomerServiceQrCode;
    help_user_feedback_url:                              CustomerServiceQrCode;
    help_video_tutorials_url:                            CustomerServiceQrCode;
    icp1:                                                CustomerServiceQrCode;
    icp2:                                                CustomerServiceQrCode;
    integration_apifox_url:                              CustomerServiceQrCode;
    integration_dingtalk_da:                             CustomerServiceQrCode;
    integration_dingtalk_help_url:                       CustomerServiceQrCode;
    integration_dingtalk_login_appid_dev:                CustomerServiceQrCode;
    integration_dingtalk_login_appid_prod:               CustomerServiceQrCode;
    integration_dingtalk_login_appid_staging:            CustomerServiceQrCode;
    integration_dingtalk_upgrade_url:                    CustomerServiceQrCode;
    integration_feishu_help:                             CustomerServiceQrCode;
    integration_feishu_help_url:                         CustomerServiceQrCode;
    integration_feishu_login_appid_dev:                  CustomerServiceQrCode;
    integration_feishu_login_appid_prod:                 CustomerServiceQrCode;
    integration_feishu_login_appid_staging:              CustomerServiceQrCode;
    integration_feishu_manage_open_url:                  CustomerServiceQrCode;
    integration_feishu_seats_form_url:                   CustomerServiceQrCode;
    integration_feishu_upgrade_url:                      CustomerServiceQrCode;
    integration_feishu_upgrade_url_dev:                  CustomerServiceQrCode;
    integration_feisu_register_link_in_login:            CustomerServiceQrCode;
    ...
    integration_wecom_bind_help_center:                  CustomerServiceQrCode;
    integration_wecom_bind_success_icon:                 CustomerServiceQrCode;
    integration_wecom_custom_subdomain_help_url:         CustomerServiceQrCode;
    integration_wecom_help_url:                          CustomerServiceQrCode;
    integration_wecom_login_qrcode_js:                   CustomerServiceQrCode;
    integration_wecom_qrcode_css:                        CustomerServiceQrCode;
    integration_wecom_shop_cms:                          CustomerServiceQrCode;
    integration_wecom_shop_corpid_dev:                   CustomerServiceQrCode;
    integration_wecom_shop_corpid_prod:                  CustomerServiceQrCode;
    integration_wecom_shop_corpid_staging:               CustomerServiceQrCode;
    integration_wecom_shop_corpid_test:                  CustomerServiceQrCode;
    integration_wecom_shop_suiteid_dev:                  CustomerServiceQrCode;
    integration_wecom_shop_suiteid_prod:                 CustomerServiceQrCode;
    integration_wecom_shop_suiteid_staging:              CustomerServiceQrCode;
    integration_wecom_shop_suiteid_test:                 CustomerServiceQrCode;
    integration_wecom_upgrade_guide_url:                 CustomerServiceQrCode;
    integration_yozosoft_help_url:                       CustomerServiceQrCode;
    ...
    login_agree_terms_of_service:                        CustomerServiceQrCode;
    login_ai_course_url:                                 CustomerServiceQrCode;
    login_icp1_url:                                      CustomerServiceQrCode;
    login_icp2_url:                                      CustomerServiceQrCode;
    login_introduction_video:                            CustomerServiceQrCode;
    login_join_chatgroup_url:                            CustomerServiceQrCode;
    login_privacy_policy:                                CustomerServiceQrCode;
    login_privacy_policy_url:                            CustomerServiceQrCode;
    login_private_deployment_form_url:                   CustomerServiceQrCode;
    login_service_agreement:                             CustomerServiceQrCode;
    login_service_agreement_url:                         CustomerServiceQrCode;
    ...
    onboarding_customer_service_background_img_url:      CustomerServiceQrCode;
    onboarding_customer_service_qrcode_avatar_img_url:   CustomerServiceQrCode;
    ...
    record_comments_help_url:                            CustomerServiceQrCode;
    ...
    space_enterprise_certification_form:                 CustomerServiceQrCode;
    space_setting_integrations_dingtalk:                 CustomerServiceQrCode;
    ...
    system_configuration_error_msg_qrcode:               CustomerServiceQrCode;
    system_configuration_logo_with_name_white_font:      CustomerServiceQrCode;
    system_configuration_minmum_version_require:         CustomerServiceQrCode;
    system_configuration_official_avatar:                CustomerServiceQrCode;
    system_configuration_official_logo:                  CustomerServiceQrCode;
    system_configuration_server_error_bg_img:            CustomerServiceQrCode;
    system_configuration_version:                        CustomerServiceQrCode;
    template_customization:                              CustomerServiceQrCode;
    template_feedback_form_url:                          CustomerServiceQrCode;
    template_space_id:                                   CustomerServiceQrCode;
    trash_url:                                           CustomerServiceQrCode;
    user_account_deleted_bg_img:                         CustomerServiceQrCode;
    user_account_deleted_img:                            CustomerServiceQrCode;
    user_feedback_url:                                   CustomerServiceQrCode;
    user_guide_welcome_developer_center_url:             CustomerServiceQrCode;
    user_guide_welcome_faq_url:                          CustomerServiceQrCode;
    user_guide_welcome_introduction_video:               CustomerServiceQrCode;
    user_guide_welcome_product_manual_url:               CustomerServiceQrCode;
    user_guide_welcome_quick_start_video:                CustomerServiceQrCode;
    user_guide_welcome_template1_icon:                   CustomerServiceQrCode;
    user_guide_welcome_template1_url:                    CustomerServiceQrCode;
    user_guide_welcome_template2_icon:                   CustomerServiceQrCode;
    user_guide_welcome_template2_url:                    CustomerServiceQrCode;
    user_guide_welcome_template3_icon:                   CustomerServiceQrCode;
    user_guide_welcome_template3_url:                    CustomerServiceQrCode;
    user_guide_welcome_what_is_datasheet_video:          CustomerServiceQrCode;
    user_setting_account_bind:                           CustomerServiceQrCode;
    user_setting_account_bind_dingtalk:                  CustomerServiceQrCode;
    user_setting_account_bind_qq:                        CustomerServiceQrCode;
    user_setting_account_bind_qq_web_appid_dev:          CustomerServiceQrCode;
    user_setting_account_bind_qq_web_appid_prod:         CustomerServiceQrCode;
    user_setting_account_bind_qq_web_appid_staging:      CustomerServiceQrCode;
    user_setting_account_bind_wechat:                    CustomerServiceQrCode;
    user_setting_account_bind_wechat_appid_dev:          CustomerServiceQrCode;
    user_setting_account_bind_wechat_appid_prod:         CustomerServiceQrCode;
    user_setting_account_bind_wechat_appid_staging:      CustomerServiceQrCode;
    user_setting_account_wallet_help_url:                CustomerServiceQrCode;
    user_setting_default_avatar:                         CustomerServiceQrCode;
    user_setting_delete_account_help_url:                CustomerServiceQrCode;
    version:                                             CustomerServiceQrCode;
    view_architecture_empty_graphics_img:                CustomerServiceQrCode;
    view_architecture_empty_record_list_img:             CustomerServiceQrCode;
    view_architecture_guide_video:                       CustomerServiceQrCode;
    view_architecture_setting_help_url:                  CustomerServiceQrCode;
    view_calendar_guide_create:                          CustomerServiceQrCode;
    view_calendar_guide_no_permission:                   CustomerServiceQrCode;
    view_calendar_guide_video:                           CustomerServiceQrCode;
    view_calendar_setting_help_url:                      CustomerServiceQrCode;
    view_form_guide_video:                               CustomerServiceQrCode;
    view_gallery_guide_video:                            CustomerServiceQrCode;
    view_gantt_config_color_help_url:                    CustomerServiceQrCode;
    view_gantt_guide_video:                              CustomerServiceQrCode;
    view_gantt_set_task_relation_help_url:               CustomerServiceQrCode;
    view_grid_guide_video:                               CustomerServiceQrCode;
    view_kanban_guide_video:                             CustomerServiceQrCode;
    view_manual_save_modal_img:                          CustomerServiceQrCode;
    view_mirror_list_empty_img:                          CustomerServiceQrCode;
    ...
    widget_center_feature_not_unturned_on_img:           CustomerServiceQrCode;
    widget_center_help:                                  CustomerServiceQrCode;
    widget_center_help_link:                             CustomerServiceQrCode;
    widget_center_help_url:                              CustomerServiceQrCode;
    widget_center_lab_unused_banner:                     CustomerServiceQrCode;
    widget_center_space_empty:                           CustomerServiceQrCode;
    widget_center_space_widget_empty_img:                CustomerServiceQrCode;
    widget_cli_min_version:                              CustomerServiceQrCode;
    widget_cli_miumum_version:                           CustomerServiceQrCode;
    widget_create_widget_help_url:                       CustomerServiceQrCode;
    widget_cret_invalid_help:                            CustomerServiceQrCode;
    widget_custom_widget_empty_img:                      CustomerServiceQrCode;
    widget_default_cover:                                CustomerServiceQrCode;
    widget_default_cover_img:                            CustomerServiceQrCode;
    widget_default_template_url:                         CustomerServiceQrCode;
    widget_develop_init_help:                            CustomerServiceQrCode;
    widget_develop_init_help_url:                        CustomerServiceQrCode;
    widget_develop_install_help:                         CustomerServiceQrCode;
    widget_develop_install_help_url:                     CustomerServiceQrCode;
    widget_develop_preview_help:                         CustomerServiceQrCode;
    widget_develop_preview_help_url:                     CustomerServiceQrCode;
    widget_develop_start_help:                           CustomerServiceQrCode;
    widget_develop_start_help_url:                       CustomerServiceQrCode;
    widget_empty:                                        CustomerServiceQrCode;
    widget_how_to_close_browser_restriction_help_url:    CustomerServiceQrCode;
    widget_panel_empty_img:                              CustomerServiceQrCode;
    widget_publish_modal_img:                            CustomerServiceQrCode;
    widget_release_help:                                 CustomerServiceQrCode;
    widget_release_help_url:                             CustomerServiceQrCode;
    workbench_folder_default_cover_list:                 CustomerServiceQrCode;
    workbench_max_node_number_show_invite_and_new_node:  CustomerServiceQrCode;
    workbench_no_permission_img:                         CustomerServiceQrCode;
    workbench_node_share_help_url:                       CustomerServiceQrCode;
    workbench_trash_help_url:                            CustomerServiceQrCode;
}
