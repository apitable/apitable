...
export type StringKeysMapType = {
  ...
  'cascader_data_source': 'cascader_data_source',
  'cascader_linked_datasheet_data': 'cascader_linked_datasheet_data',
  'cascader_old_snapshot_data': 'cascader_old_snapshot_data',
