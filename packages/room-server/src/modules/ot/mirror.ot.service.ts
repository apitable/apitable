...
import { IJOTAction, IMirrorSnapshot, IOperation, IRemoteChangeset, jot } from '@vikadata/core';
...
import { EffectConstantName, ICommonData } from 'modules/ot/ot.interface';
...
import { WidgetService } from 'modules/services/widget/widget.service';
