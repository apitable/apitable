...
import { evaluate, FieldType, getNewId, IDPrefix, IFormulaField, IViewRow, Selectors } from '@apitable/core';
...
export const getVisibleRows = (data: IWorkerGetVisibleRowsJobData): IViewRow[] => {
  ...
  return Selectors.getVisibleRowsBase(state, snapshot, view);
};
