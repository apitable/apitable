    ...
    <>
      {index === 0 && (
        <Box display="flex" alignItems="center">
          <Box height="12px" width="2px" backgroundColor={theme.color.fc0} marginRight="4px" />
      ...
      >
        <Box display="flex" alignItems="center" justifyContent="space-between" width="100%">
          <Box display="flex" alignItems="center" onClick={() => setShow(!show)} width="100%" style={{ cursor: 'pointer' }}>
            <span
              style={{
                borderRadius: 4,
                marginRight: '4px',
        ...
        {show && (
          <Box marginTop="13px" paddingTop="16px" borderTop={`1px solid ${theme.color.lineColor}`}>
            ...
            <MagicVariableForm {...restProps} ref={ref} liveValidate style={{ marginTop: -24 }}>
              <Box marginTop="16px" display="flex" flexDirection="row-reverse">
                <Box display="flex">
                  <Button onClick={() => setShow(!show)} variant="fill" size="small" style={{ marginRight: 16 }}>
