    ...
    <div className={styles.leftWrapper}>
      <Typography variant={'body1'} component={'span'} className={styles.text}>
        <TComponent
          ...
          params={{
            name: <span className={styles.targetClx}>
              {targetIcon}
              <Typography variant={'h6'} component={'span'} ellipsis style={{ flex: 1, maxWidth: isMobile ? 95 : 270 }}>{targetName}</Typography>
            </span>,
            type: typeName,
          }}
        />
