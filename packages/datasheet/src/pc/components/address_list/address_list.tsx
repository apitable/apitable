...
import { isContactSyncing, isSocialDingTalk } from '../home/social_platform';
        ...
        (
          <div className={styles.teamTitle}>
            <ComponentDisplay minWidthCompatible={ScreenSize.md}>
              <Tooltip
                title={selectedTeamInfo.teamTitle}
            ...
            <span>（{memberList.length}{t(Strings.person)}）</span>
          </div>
        )
      }
              ...
              <>
                ...
                <ComponentDisplay minWidthCompatible={ScreenSize.md}>
                  <div className={styles.memberInfo}>
                    {memberInfo.memberId ?
                      <MemberInfo /> : <span className={styles.emptyImage}><Image src={OrgImage} alt={t(Strings.empty_data)} /></span>}
                  </div>
                </ComponentDisplay>
              </>
            ) :
            <span className={styles.emptyImage}><Image src={OrgImage} alt={t(Strings.empty_data)} /></span>
        }
      </div>
    </div>
  );
