    ...
    <>
      {
        ...
        <>
          <div className={styles.otherLogin}>
            {isWecom ? <WecomLoginBtn/> : <>
              <div className={styles.otherDivider}><div className={styles.text}>{t(Strings.quick_login)}</div></div>
      ...
      {!isMobile &&
        <div className={styles.divider}><div className={styles.text}>{modTitleText}</div></div>
      }
          ...
          !responsive.large || !isWecom ? <>
            ...
            <div className={styles.buttonGroupDesktop}>
              ...
              <Trigger
                ...
                destroyPopupOnHide
                popupAlign={
                  { points: ['b', 'c'], offset: [0, -20], overflow: { adjustX: true, adjustY: true }}
                }
