        ...
        {isInvited ? (
          <div className={styles.invitedRes}>
            ...
            <div className={styles.btnWrapper}>
              <TextButton onClick={continueInvite} size="small">
          ...
          <>
            <div className={styles.itemWrapper}>
              <div>
                <Button onClick={addMemberItem} prefixIcon={<AddOutlined size={16} color="currentColor" />} className={styles.add}>
                  {t(Strings.button_add)}
                </Button>
              </div>
              <div className={styles.itemContent}>{renderInputItems()}</div>
            </div>
            <div className={styles.inviteBtn}>
              <div className={styles.tipText} style={{ flex: 1 }}>
