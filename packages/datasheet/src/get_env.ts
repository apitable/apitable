...
export const getEnvVars = () => {
  return {
    ...
    SPACE_UPGRADE_PAGE_VISIBLE: process.env.SPACE_UPGRADE_PAGE_VISIBLE === 'true',
    FIELD_CASCADE_VISIBLE: process.env.FIELD_CASCADE_VISIBLE === 'true',
    INVITATION_CODE_VISIBLE: process.env.INVITATION_CODE_VISIBLE === 'true',
    SOCIAL_LOGIN_QQ_VISIBLE: process.env.SOCIAL_LOGIN_QQ_VISIBLE === 'true',
    SOCIAL_LOGIN_WECHAT_VISIBLE: process.env.SOCIAL_LOGIN_WECHAT_VISIBLE === 'true',
    SOCIAL_LOGIN_DINGTALK_VISIBLE: process.env.SOCIAL_LOGIN_DINGTALK_VISIBLE === 'true',
    USER_SETTING_SOCIAL_LOGIN_VISIBLE: process.env.USER_SETTING_SOCIAL_LOGIN_VISIBLE === 'true',
    ASSISTANT_VISIBLE: process.env.ASSISTANT_VISIBLE === 'true',
    HELP_MENU_DOWNLOAD_APP_VISIBLE: process.env.HELP_MENU_DOWNLOAD_APP_VISIBLE === 'true',
    ...
    SHARE_PUBLIC_LINK_QRCODE_ASSISTANT_VISIBLE: process.env.SHARE_PUBLIC_LINK_QRCODE_ASSISTANT_VISIBLE === 'true',
    ...
    GAIN_ATTACHMENT_CAPACITY_VISIBLE: process.env.GAIN_ATTACHMENT_CAPACITY_VISIBLE === 'true',
    ...
    LOGIN_INTRODUCTION_VIDEO_VISIBLE: process.env.LOGIN_INTRODUCTION_VIDEO_VISIBLE === 'true',
    ...
    HELP_MENU_SMART_ONBOARDING_VISIBLE: process.env.HELP_MENU_SMART_ONBOARDING_VISIBLE === 'true',
    MOBILE_USER_SETTING_PRIVACY_POLICY_VISIBLE: process.env.MOBILE_USER_SETTING_PRIVACY_POLICY_VISIBLE === 'true',
    MOBILE_USER_SETTING_SERVICE_AGREEMENT_VISIBLE: process.env.MOBILE_USER_SETTING_SERVICE_AGREEMENT_VISIBLE === 'true',
    CREATE_ROBOT_AVATAR: process.env.CREATE_ROBOT_AVATAR,
    ROBOT_DEFAULT_AVATAR: process.env.ROBOT_DEFAULT_AVATAR,
    DISABLED_SENSORS: process.env.DISABLED_SENSORS === 'true',
