...
export const getEnvVars = () => {
  return {
    ...
    HIDDEN_BASE_USER_PROFILE: process.env.HIDDEN_BASE_USER_PROFILE,
    HIDDEN_USER_CHANGE_PASSWORD: process.env.HIDDEN_USER_CHANGE_PASSWORD,
    HIDDEN_ACCOUNT_LINK_MANAGER: process.env.HIDDEN_ACCOUNT_LINK_MANAGER,
    HIDDEN_CHANGE_SPACE_ADMIN: process.env.HIDDEN_CHANGE_SPACE_ADMIN
  };
};
