...
export const getEnvVars = () => {
  return {
    ...
    VIKA_COMMUNITY_URL_PROD: process.env.VIKA_COMMUNITY_URL,
    VIKA_CLASSROOM_URL: process.env.VIKA_CLASSROOM_URL,
    ACCOUNT_WALLET_HELP: process.env.ACCOUNT_WALLET_HELP,
    INTRODUCTION_VIDEO: process.env.INTRODUCTION_VIDEO,
    TEMPLATE_CUSTOMIZATION: process.env.TEMPLATE_CUSTOMIZATION,
