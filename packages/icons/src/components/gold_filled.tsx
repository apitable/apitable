...
export const GoldFilled: React.FC<IIconProps> = makeIcon({
  Path: ({ colors }) => <>
    ...
    <path d="M9.99951 7.25703V8.25703L15.9995 12.9993L21.9995 8.25703V7.25703L15.9995 11.9993L9.99951 7.25703Z" fill={ colors[0] }/>
    <rect x="16.9998" y="2" width="2" height="9" fill={ colors[4] }/>
    <rect x="12.9998" y="2" width="2" height="9" fill={ colors[4] }/>
    <path d="M9 1.5C9 1.22386 9.22386 1 9.5 1H22.5C22.7761 1 23 1.22386 23 1.5V1.5C23 1.77614 22.7761 2 22.5 2H16H9.5C9.22386 2 9 1.77614 9 1.5V1.5Z" fill={ colors[0] }/>
    <path d="M15.2178 7.89202L7.21783 12.7809C6.77194 13.0534 6.5 13.5383 6.5 14.0608V23.9392C6.5 24.4617 6.77194 24.9466 7.21782 25.2191L15.2178 30.108C15.698 30.4014 16.302 30.4014 16.7822 30.108L24.7822 25.2191C25.2281 24.9466 25.5 24.4617 25.5 23.9392V14.0608C25.5 13.5383 25.2281 13.0534 24.7822 12.7809L16.7822 7.89202C16.302 7.59859 15.698 7.59859 15.2178 7.89202Z" fill={ colors[3] } stroke={ colors[1] } strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M16 14L15 13V17H16V14Z" fill={ colors[1] }/>
    <path d="M15 13H11V17V21V25L15 21L19 17L23 13H19L15 17V13Z" fill={ colors[4] } fillRule="evenodd" clipRule="evenodd"/>
    <path d="M23 14V13L11 25V26L23 14Z" fill={ colors[1] }/>
