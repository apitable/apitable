...
```jsx
import { Divider } from '@vikadata/components';
```
...
<Canvas>
  <div>
    <Divider>vika 维格表</Divider>
    {content}
    <Divider textAlign="left">vika 维格表</Divider>
    {content}
    <Divider textAlign="right">vika 维格表</Divider>
  </div>
</Canvas>
...
<Canvas>
  <div>
    <Divider>vika 维格表</Divider>
    {content}
    <Divider typography="h2">vika 维格表</Divider>
    {content}
    <Divider typography="body4">vika 维格表</Divider>
  </div>
</Canvas>
...
<Canvas>
  <div>
    ...
    <Divider dashed />
    {content}
    <Divider dashed>vika 维格表</Divider>
    {content}
  </div>
</Canvas>
