import { 
  ...
  ChartColumnStackFilled, FavoriteOutlined, CalenderLeftOutlined
} from '@vikadata/icons';
...
从 `@vikadata/icons` 中引入需要的 Icon。

```tsx
import { CheckedOutlined } from '@vikadata/icons';
```
