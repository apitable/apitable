...
Ви можете змінювати файли markdown в вихідному коді і створювати їх безпосередньо

Крім того, для тексту інтерфейсу користувача ви можете змінити `рядки` у файлах коду безпосередньо, вони розташовані за адресою（Різним мовам відповідають різні мовні файли）:
