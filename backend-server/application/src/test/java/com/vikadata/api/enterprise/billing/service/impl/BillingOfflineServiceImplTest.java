...
public class BillingOfflineServiceImplTest extends AbstractIntegrationTest {
    ...
    public void testCreateGiftCapacityOrder() {
        ...
        iSpaceSubscriptionService.createAddOnWithGiftCapacity(mockUserSpace.getUserId(), userName, mockUserSpace.getSpaceId());
        ...
        IPage<SpaceCapacityPageVO> spaceCapacityPageVOIPage = iBillingCapacityService.getSpaceCapacityDetail(mockUserSpace.getSpaceId(), false, new Page<>());
