package com.vikadata.api.enterprise.gm.service.impl;
...
public class GmServiceImplTest extends AbstractEnterpriseIntegrationTest {
    ...
    public void testSpaceSubscriptionSuccessCapacity() {
        ...
        long expectSize = afterSubscribe.getFeature().getCapacitySize().getValue() - beforeSubscribe.getFeature().getCapacitySize().getValue();
        assertThat(expectSize).isEqualTo(5 * 1024 * 1024 * 1024L);
    }
