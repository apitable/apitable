...
public class NotificationConstants {
    ...
    public static final String BODY_REQUEST_DESC =
            "Description:{\"extras\":{\"viewId\":\"view ID\",\"recordIds\":[\"record ID\", \"record ID\"], \"toast\": " +
                    "{\"hiddenVikaby\": \"whether to show vikaby s avatar，default false\", \"allowPrev\": \"When the page changes toast, do you need to destroy the existing toast on the page，default false\", " +
