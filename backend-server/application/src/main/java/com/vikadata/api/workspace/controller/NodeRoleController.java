...
import com.vikadata.api.workspace.ro.AddNodeRoleRo;
import com.vikadata.api.workspace.ro.BatchDeleteNodeRoleRo;
import com.vikadata.api.workspace.ro.BatchModifyNodeRoleRo;
import com.vikadata.api.workspace.ro.DeleteNodeRoleRo;
import com.vikadata.api.workspace.ro.ModifyNodeRoleRo;
import com.vikadata.api.workspace.vo.NodeCollaboratorsVo;
...
public class NodeRoleController {
    ...
    public ResponseData<Void> disableRoleExtend(@RequestParam(name = "nodeId") String nodeId,
        ...
        iControlService.checkControlStatus(nodeId,
            status -> ExceptionUtil.isFalse(status, PermissionException.NODE_ROLE_HAS_DISABLE_EXTEND));
    ...
    public ResponseData<Void> enableRoleExtend(@RequestParam(name = "nodeId") String nodeId) {
        ...
        iControlService.checkControlStatus(nodeId,
            status -> ExceptionUtil.isTrue(status, PermissionException.NODE_ROLE_HAS_DISABLE_EXTEND));
    ...
    public ResponseData<Void> createRole(@RequestBody @Valid AddNodeRoleRo data) {
        ...
        // the root node cannot be operated
        String rootNodeId = iNodeService.getRootNodeIdBySpaceId(spaceId);
        ExceptionUtil.isFalse(rootNodeId.equals(data.getNodeId()), PermissionException.NODE_OPERATION_DENIED);
        // check whether user have permission
