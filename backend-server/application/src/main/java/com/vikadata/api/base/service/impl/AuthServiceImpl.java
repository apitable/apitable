...
import static com.vikadata.api.user.enums.UserException.AUTH_INFO_NO_VALID;
import static com.vikadata.api.user.enums.UserException.LOGIN_OFTEN;
import static com.vikadata.api.user.enums.UserException.MOBILE_BOUND_EMAIL_DUPLICATE;
...
import static com.vikadata.api.user.enums.UserException.REGISTER_BY_INVITE_CODE_OPERATION_FREQUENTLY;
...
public class AuthServiceImpl implements IAuthService {
    ...
    public UserLoginResult loginBySmsCode(LoginRo loginRo) {
        ...
        // Check parameters
        ExceptionUtil.isNotBlank(code, ActionException.CODE_EMPTY);
