...
import static com.vikadata.api.shared.constants.WidgetAssetConstants.TOKEN_MAX;
import static com.vikadata.api.shared.constants.WidgetAssetConstants.WIDGET_PREFIX;
...
public class AssetUploadTokenServiceImpl implements IAssetUploadTokenService {
    ...
    private List<String> getFilePositions(String packageId, WidgetAssetUploadCertificateRO data) {
        ...
        if (widgetFileType == WidgetFileType.ASSET) {
            ...
            ExceptionUtil.isFalse(data.getFilenames().size() > TOKEN_MAX, ParameterException.INCORRECT_ARG);
        ...
        ExceptionUtil.isFalse(data.getCount() > TOKEN_MAX, ParameterException.INCORRECT_ARG);
        String prefix;
