...
import com.apitable.shared.sysconfig.wizard.PlayerConfig;
...
public class LanguageConstants {
    ...
    static {
        try (InputStream resourceAsStream = PlayerConfigLoader.class.getResourceAsStream("/sysconfig/language.manifest.json")) {
            if (resourceAsStream == null) {
                throw new IOException("Language Manifest file not found!");
            }
            ObjectNode manifest = Converter.getObjectMapper().readValue(resourceAsStream, ObjectNode.class);
