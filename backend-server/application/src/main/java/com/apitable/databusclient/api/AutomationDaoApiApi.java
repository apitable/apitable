...
public class AutomationDaoApiApi {
     ...
     */
    public ApiResponseAutomationRobotSO daoGetRobotsByResourceId(String resourceId) throws ApiException {
        ApiResponse<ApiResponseAutomationRobotSO> localVarResp = daoGetRobotsByResourceIdWithHttpInfo(resourceId);
     ...
     */
    public ApiResponse<ApiResponseAutomationRobotSO> daoGetRobotsByResourceIdWithHttpInfo(String resourceId) throws ApiException {
     ...
     */
    public okhttp3.Call daoGetRobotsByResourceIdAsync(String resourceId, final ApiCallback<ApiResponseAutomationRobotSO> _callback) throws ApiException {
