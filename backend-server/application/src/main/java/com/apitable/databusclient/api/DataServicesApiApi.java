...
import com.apitable.databusclient.model.ApiResponseDatasheetPackSO;
...
public class DataServicesApiApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> get data pack data </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getDatasheetPackCall(String id, String userId, String spaceId, String viewId, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getDatasheetPackValidateBeforeCall(String id, String userId, String spaceId, String viewId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getDatasheetPack(Async)");
        }

        return getDatasheetPackCall(id, userId, spaceId, viewId, _callback);
     ...
     */
    public ApiResponseDatasheetPackSO getDatasheetPack(String id, String userId, String spaceId, String viewId) throws ApiException {
        ApiResponse<ApiResponseDatasheetPackSO> localVarResp = getDatasheetPackWithHttpInfo(id, userId, spaceId, viewId);
     ...
     * @param spaceId  (optional)
     * @param viewId  (optional)
     * @return ApiResponse&lt;ApiResponseDatasheetPackSO&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ApiResponseDatasheetPackSO> getDatasheetPackWithHttpInfo(String id, String userId, String spaceId, String viewId) throws ApiException {
        okhttp3.Call localVarCall = getDatasheetPackValidateBeforeCall(id, userId, spaceId, viewId, null);
        Type localVarReturnType = new TypeToken<ApiResponseDatasheetPackSO>(){}.getType();
     ...
     */
    public okhttp3.Call getDatasheetPackAsync(String id, String userId, String spaceId, String viewId, final ApiCallback<ApiResponseDatasheetPackSO> _callback) throws ApiException {

        okhttp3.Call localVarCall = getDatasheetPackValidateBeforeCall(id, userId, spaceId, viewId, _callback);
        Type localVarReturnType = new TypeToken<ApiResponseDatasheetPackSO>(){}.getType();
