...
public class DataServicesApiApi {
     ...
     */
    public ApiResponseDatasheetPackSO getDatasheetPack(String id, String userId, String spaceId) throws ApiException {
        ApiResponse<ApiResponseDatasheetPackSO> localVarResp = getDatasheetPackWithHttpInfo(id, userId, spaceId);
     ...
     */
    public ApiResponse<ApiResponseDatasheetPackSO> getDatasheetPackWithHttpInfo(String id, String userId, String spaceId) throws ApiException {
     ...
     */
    public okhttp3.Call getDatasheetPackAsync(String id, String userId, String spaceId, final ApiCallback<ApiResponseDatasheetPackSO> _callback) throws ApiException {
