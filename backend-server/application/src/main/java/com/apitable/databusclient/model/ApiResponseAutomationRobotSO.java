...
public class ApiResponseAutomationRobotSO {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ApiResponseAutomationRobotSO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ApiResponseAutomationRobotSO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ApiResponseAutomationRobotSO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApiResponseAutomationRobotSO` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        AutomationRobotSO.validateJsonObject(jsonObj.getAsJsonObject("data"));
      }
