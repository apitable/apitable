...
public class AnyBaseField extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!AnyBaseField.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'AnyBaseField' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<AnyBaseField>() {
                @Override
                public void write(JsonWriter out, AnyBaseField value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: Double, Integer, String");
                }

                @Override
                public AnyBaseField read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        AnyBaseField ret = new AnyBaseField();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for AnyBaseField: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public AnyBaseField(Double o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public AnyBaseField(Integer o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public AnyBaseField(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
  ...
  * @throws IOException if the JSON Element is invalid with respect to AnyBaseField
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for AnyBaseField with oneOf schemas: Double, Integer, String. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
    }
  }

 /**
  * Create an instance of AnyBaseField given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AnyBaseField
  * @throws IOException if the JSON string is invalid with respect to AnyBaseField
  */
  public static AnyBaseField fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AnyBaseField.class);
  }

 /**
  * Convert an instance of AnyBaseField to an JSON string
  *
  * @return JSON string
  */
