...
public class OrderV2ServiceImplTest extends AbstractIntegrationTest {
    ...
    public void testCreateOrderOnNewBuySenseWithTargetDate() {
        ...
        Price silverPrice = BillingConfigManager.getPriceBySeatAndMonths(toBuy, 20, 12);
        ...
        ProductEnum toBuyProductAgain = ProductEnum.SILVER;
        Price buyAgainPrice = BillingConfigManager.getPriceBySeatAndMonths(toBuyProductAgain, 20, 12);
        ...
        // check space entitlement
        entitlementChecker.checkSubscription(mockUserSpace.getSpaceId(),
                new ExpectedSubscriptionCheck(toBuy, initialCreateDate.toLocalDate(), nowShouldExpireDate));
    }
    ...
    public void testCreateOrderOnUpgradeSenseOnSameDay() {
        ...
        Price silverPrice = BillingConfigManager.getPriceBySeatAndMonths(toBuy, 5, 6);
        assertThat(silverPrice).isNotNull();
        ...
        // upgrade product
        ProductEnum toUpgrade = ProductEnum.SILVER;
        // now we take to operate upgrade request, we assume this plan is 1368
        Price goldPrice = BillingConfigManager.getPriceBySeatAndMonths(toUpgrade, 10, 6);
        ...
        // the pro-rate piece
        entitlementChecker.checkSubscription(mockUserSpace.getSpaceId(),
                new ExpectedSubscriptionCheck(toUpgrade, initialCreateDate.toLocalDate(), shouldExpireDate));
    }
    ...
    public void testCreateOrderOnSimpleUpgradeSenseWithTargetDate() {
        ...
        Price goldPrice = BillingConfigManager.getPriceBySeatAndMonths(toUpgrade, 100, 12);
        assertThat(goldPrice).isNotNull();
        final OrderArguments upgradeOrderArguments = new DefaultOrderArguments(mockUserSpace.getSpaceId(), goldPrice);
    ...
    public void testCreateOrderOnUpgradeSenseExpectProrated() {
        ...
        Price silverPrice = BillingConfigManager.getPriceBySeatAndMonths(toBuy, 10, 1);
        assertThat(silverPrice).isNotNull();
        BillingPlanPrice planPrice = BillingPlanPrice.of(silverPrice, ClockManager.me().getLocalDateNow());
        BigDecimal amount = planPrice.getActual();
        log.info("current plan amount is {}", amount);
        ...
        Price upgradePrice = BillingConfigManager.getPriceBySeatAndMonths(toUpgrade, 20, 1);
    ...
    public void testCreateOrderOnUpgradeComplexSense() {
        ...
        // now we take to operate upgrade request, we assume this plan is 588
        Price upgradePrice = BillingConfigManager.getPriceBySeatAndMonths(toBuy, 20, 1);
        assertThat(upgradePrice).isNotNull();
        final OrderArguments upgradeOrderArguments = new DefaultOrderArguments(mockUserSpace.getSpaceId(), upgradePrice);
        ...
        final LocalDate nowShouldExpireDate = LocalDate.of(2019, 5, 21);
        entitlementChecker.checkSubscription(mockUserSpace.getSpaceId(),
                new ExpectedSubscriptionCheck(toBuy, upgradeDate.toLocalDate(), nowShouldExpireDate));
        ...
        Price upgradeAgainPrice = BillingConfigManager.getPriceBySeatAndMonths(toBuy, 30, 1);
