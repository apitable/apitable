...
import com.vikadata.api.modular.organization.mapper.RoleMemberMapper;
...
import static com.vikadata.api.enums.exception.OrganizationException.ADD_ROLE_MEMBER_ERROR;
...
public class RoleMemberServiceImpl extends ServiceImpl<RoleMemberMapper, RoleMemberEntity> implements IRoleMemberService {
    ...
    public List<Long> addRoleMembers(Long roleId, List<RoleMemberUnitRo> unitList) {
        ...
        ExceptionUtil.isTrue(flag, ADD_ROLE_MEMBER_ERROR);
