 ...
 *
 * @author Zoe Zheng
 * @date 2021-03-23 17:39:52
 */
public interface IGrpcClientService {
    /**
     * 通过中间层生成复制节点产生的changeset，并且通知到长链房间
     *
     * @param ro 请求中间层的参数
     * @return BasicResult
     * @author zoe zheng
     * @date 2021/3/31 4:24 下午
     */
    BasicResult nodeCopyChangeset(NodeCopyRo ro);

    /**
     * 通过中间层生成删除节点产生的changeset, 并且通知到长链房间
     *
     * @param ro 请求中间层参数
     * @return BasicResult
     * @author zoe zheng
     * @date 2021/4/1 12:14 下午
     */
