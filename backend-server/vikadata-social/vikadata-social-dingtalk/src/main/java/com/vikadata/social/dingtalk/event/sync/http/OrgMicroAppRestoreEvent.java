...
@Getter
@ToString
@DingTalkEvent(value = DingTalkEventTag.SYNC_HTTP_PUSH_HIGH, action = DingTalkSyncAction.ORG_MICRO_APP_RESTORE)
public class OrgMicroAppRestoreEvent extends BaseOrgMicroAppEvent {
}
