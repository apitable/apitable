...
@Getter
@ToString
@DingTalkEvent(value = DingTalkEventTag.SYNC_HTTP_PUSH_HIGH, action = DingTalkSyncAction.ORG_SUITE_RELIEVE)
public class OrgSuiteRelieveEvent extends BaseOrgSuiteEvent {
}
