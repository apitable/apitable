...
@Getter
@ToString
@DingTalkEvent(value = DingTalkEventTag.SYNC_HTTP_PUSH_MEDIUM, action = DingTalkSyncAction.USER_ADD_ORG)
public class SyncHttpUserAddOrgEvent extends BaseOrgUserContactEvent {
}
